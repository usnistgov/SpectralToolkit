...
% this will only calculate one phase
    ...
    for k = 1:MaxIter
       ...
       H = [cos(wF*tn + Afm*sin(wm*tn + phif))', ...
           ...
           cos((wf-(2*wm))*tn + Afm*sin(wm*tn+phif))',...
           sin((wf-(2*wm))*tn + Afm*sin(wm*tn+phif))',... 
           cos((wF+wm)*tn + Afm*sin(wm*tn + phif))', ...
           sin((wF+wm)*tn + Afm*sin(wm*tn + phif))', ...
           cos((wF+(2*wm))*tn + Afm*sin(wm*tn + phif))', ...
           sin((wF+(2*wm))*tn + Afm*sin(wm*tn + phif))', ...           
       ...
       AU1 = sqrt(S(7)^2 + S(8)^2); phiU1 = atan2(-S(7),S(8));
       AU2 = sqrt(S(9)^2 + S(10)^2); phiU2 = atan2(-S(9),S(10));
       
       %LV reverse engineering - ModPhaseFit.vi
       mi = (AU1*cos(phiU1 - phiF) - AL*cos(phiL1-phiF)) + 1i*(AU1*sin(phiU - phiF) - AL1*sin(phiL1-phiF));
       su = (AU1*cos(phiU1 - phiF) + AL*cos(phiL1-phiF)) + 1i*(AU*sin(phiU1 - phiF) + AL*sin(phiL1-phiF));
