classdef ArtificialTS
    ...
    methods
        ...
        function ArtTS = ArtificialTS(varargin)
            ...
            addParameter(p,'Extent',defaultExtent,validScalarPosNum);
            addParameter(p,'nSamples',defaultnSamples,validScalarPosInt);
            addParameter(p,'Freqs',defaultFreqs,@isvector);
            addParameter(p,'Amps',defaultAmps,@isvector);
            addParameter(p,'Phases',defaultPhases,@isvector);
            addParameter(p,'NoiseUniformLow',defaultNoiseUniformLow,validScalar);
            addParameter(p,'NoiseUniformHi',defaultNoiseUniformHi,validScalar);
            addParameter(p,'NoiseGaussMean',defaultNoiseGaussMean,validScalar);
            addParameter(p,'NoiseGaussSD',defaultNoiseGaussSD,validScalar);
            addParameter(p,'RngState',defaultRngState);
